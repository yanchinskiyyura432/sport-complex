...
import BenefitsPhoto from '@/assets/BenefitsPhoto.jpg';
...
const Benefits = (props: Props) => {
	return (
		<section id="benefits" className="mx-auto min-h-full text-black w-5/6 py-20">
			<motion.div onViewportEnter={() => props.setSelectedPage(SelectedPage.Benefits)}>
				...
				<div className="mt-16 items-center justify-between gap-20 md:mt-28 md:flex">
					{ /* GRAPHIC */}
					<img className="mx-auto w-1/2" src={BenefitsPhoto} alt="benefits-page-graphic" />
